...
import { createAccountAction } from "../../redux/features/auth/auth.slice";
export default function Register() {
  ...
  function onSubmit(data) {
    if (isValidPhoneNumber(phoneNumber)) {
      ...
      dispatch(createAccountAction({ finalData, notifyToaster }));
    } else {
      setPhoneNumberErrorMsg(
        "Please specify country code with your phone number!"
      );
    }
  }
  return (
